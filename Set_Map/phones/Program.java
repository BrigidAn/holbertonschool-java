...
public class Program {
    public static void main(String[] args) {
        ...
        System.out.println(result1 == null ? "Phones not found" : result1);

        ArrayList<Phone> result2 = phoneList1.isFind("Tom Smith");
        System.out.println(result2 == null ? "Phones not found" : result2);

        ArrayList<Phone> result3 = phoneList1.isFind("Carlos Alberto");
        System.out.println(result3 == null ? "Phones not found" : result3);

        ArrayList<Phone> result4 = phoneList1.isFind("Richard Bob");
        System.out.println(result4 == null ? "Phones not found" : result4);
    }
}
